...
- [x] Assess configured late or missed contribution penalties with an explicit penalty currency.
...
Contribution records now classify payment states from explicit timezone-aware timestamps, reject duplicate records unless adjusted explicitly, assess configured penalties with explicit currency metadata, and expose Decimal-based expected, received, and outstanding totals.
